...
?><div class="panel-body red">
                        <i class="fa fa-file fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo htmlentities($totalcat);?> </b><a href="manage-category.php">Total Category</a> 
</div>
                    </div>
                </div>
                <div class="col-lg-4">
...
?><div class="panel-body green">
       ...
       <div class="col-lg-4">
                    ...
                    <div class="alert alert-success text-center">
                        <?php 
$sql ="SELECT ID from tbladmin where UserRole='0'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$totalsuadmin=$query->rowCount();
?><div class="panel-body yellow">
                        <i class="fa  fa-users fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo htmlentities($totalsuadmin);?></b><a href="manage-subadmins.php"> Total Sub-Admin</a>
                    </div>
                    </div>
                </div>
