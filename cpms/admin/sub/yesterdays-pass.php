...
<head>
    ...
    <title>Curfew Pass Management System | Pass Created Yesterday</title>
       ...
       <?php include_once('includes/header.php');?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Pass Created Yesterday</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
...
$sql="SELECT * from tblpass where date(PasscreationDate)=CURDATE()-1 && CreatedBy='$createdby'";
