...
{               ?>
    ...
    <li>
                        <a href="#"><i class="fa fa-users fa-fw"></i> Sub-Admin<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add-subadmin.php">Add Sub-admin</a>
                            </li>
                            <li>
                                <a href="manage-subadmins.php">Manage Sub-admin</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                     <a href="pass-bwdates-report.php"> B/w Dates Report</a>
                            </li>
                            <li>
                                <a href="createdby-report.php">Created By Report</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
